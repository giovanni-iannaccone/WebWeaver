...
func (IpHashAlgorithm) NextServer(servers *[]server.ServerData, ip string) int {
...
func (a *RoundRobinAlgorithm) NextServer(servers *[]server.ServerData, _ string) int {
...
func (RandomAlgorithm) NextServer(servers *[]server.ServerData, _ string) int {
